  ...
  'syms': { 'dog_breed_id.benchmark': { 'dog_breed_id.benchmark.DogBreedClassificationDataset': ( 'benchmark.html#dogbreedclassificationdataset',
            ...
            'dog_breed_id.data_preprocessing': { 'dog_breed_id.data_preprocessing.annotated_image': ( 'data_preprocessing.html#annotated_image',
                                                 ...
                                                 'dog_breed_id.data_preprocessing.to_coco': ( 'data_preprocessing.html#to_coco',
                                                                                              'dog_breed_id/data_preprocessing.py')},
            'dog_breed_id.engine': {},
            'dog_breed_id.gradio_client': { 'dog_breed_id.gradio_client.predict_image': ( 'client.html#predict_image',
                                                                                          'dog_breed_id/gradio_client.py')},
            'dog_breed_id.gradio_interface': { 'dog_breed_id.gradio_interface.process': ( 'gradio_interface.html#process',
                                                                                          'dog_breed_id/gradio_interface.py')},
            'dog_breed_id.inference': { 'dog_breed_id.inference.DogBreedDetector': ( 'inference.html#dogbreeddetector',
                                                                                     'dog_breed_id/inference.py'),
                                        'dog_breed_id.inference.DogBreedDetector.__call__': ( 'inference.html#dogbreeddetector.__call__',
                                                                                              'dog_breed_id/inference.py'),
                                        'dog_breed_id.inference.DogBreedDetector.__init__': ( 'inference.html#dogbreeddetector.__init__',
                                                                                              'dog_breed_id/inference.py'),
                                        'dog_breed_id.inference.DogBreedDetector._infer_box': ( 'inference.html#dogbreeddetector._infer_box',
                                                                                                'dog_breed_id/inference.py'),
                                        'dog_breed_id.inference.DogBreedDetector._infer_class': ( 'inference.html#dogbreeddetector._infer_class',
                                                                                                  'dog_breed_id/inference.py'),
                                        'dog_breed_id.inference.annotate_prediction': ( 'inference.html#annotate_prediction',
                                                                                        'dog_breed_id/inference.py'),
                                        'dog_breed_id.inference.infer_boxes': ('inference.html#infer_boxes', 'dog_breed_id/inference.py'),
                                        'dog_breed_id.inference.infer_class': ('inference.html#infer_class', 'dog_breed_id/inference.py')},
            'dog_breed_id.model_training': { 'dog_breed_id.model_training.get_subsets': ( 'training.html#get_subsets',
